...
?>
			<main class="main">
				<section class="promo-primary">
					<picture>
						<source srcset="img/edu.jfif" media="(min-width: 992px)"/><img class="img--bg" src="img/edu.jfif" alt="img"/>
					</picture>
							...
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item"><span class="promo-primary__pre-title">Helpo</span>
										<h1 class="promo-primary__title"><span>Education</span></h1>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="donation-item">
									<div class="donation-item__img"><img class="img--bg" src="img/edu.jfif" alt="img"/></div>
									<div class="donation-item__body">
										<div class="row">
											<div class="col-12">
												<h5 class="donation-item__title">Education</h5>
											</div>
										</div>
								...
								<div class="tabs horizontal-tabs cause-details-tabs">
									...
									<div class="horizontal-tabs__content">
										<div class="horizontal-tabs__item" id="horizontal-tabs__item-1">
											<p><strong>Education charities make learning possible for students of all ages, from pre-school to graduate school. They also provide other educational services and opportunities that help make schools more effective and more accessible to students of all backgrounds. We classify Education charities into six Causes:</strong></p>
											<p>Adult Education Programs and Services organizations focus on leadership and/or professional development for adults. These programs typically operate outside the formal educational system and provide an array of opportunities for adults to expand their knowledge in a particular field or discipline. Adults are encouraged to explore and develop skills in a new area of interest, learn English as a second language, or complete their high school education.</p>
											<p>AEarly Childhood Programs and Services include nursery schools, kindergartens, and/or other education services that provide foundation-level learning and/or literacy for children prior to entering the formal school setting.</p>
							...
							<div class="causes-slider offset-margin">
								...
								<div class="causes-slider__item">
									<div class="causes-item causes-item--primary">
										<div class="causes-item__body">
											<div class="causes-item__top">
												<h6 class="causes-item__title"> <a href="cause-details.html">Education</a></h6>
												<p>Sharksucker sea toad candiru rocket danio tilefish stingray deepwater stingray Sacramento splittail</p>
											</div>
											<div class="causes-item__img">
