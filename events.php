										...
										<div class="row align-items-center">
											...
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details1">The Culture of India. Rebirth</a></h6>
								...
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											...
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details3">Bike Racing Charity Event 2019</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
								...
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											...
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details4">Trinity Trash Bash</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
								...
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											...
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details5">Snowdon by Night</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
								...
								<div class="upcoming-item">
									...
									<div class="upcoming-item__body">
										<div class="row align-items-center">
											...
											<div class="col-lg-7 col-xl-8">
												<div class="upcoming-item__description">
													<h6 class="upcoming-item__title"><a href="event-details6">The Big Sleep Out</a></h6>
													<p>Minnow snoek icefish velvet-belly shark, California halibut round stingray northern sea robin. Southern grayling trout-perch.</p>
													<div class="upcoming-item__details">
														<p>
															<svg class="icon">
